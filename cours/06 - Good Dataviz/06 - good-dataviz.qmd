...
- Temporelle
- Quand,
- sur quelles périodes, à -- quelle fréquence, selon     - quelle régularité -- ----- temporelle, etc. --   -------
- Quantitative
- Combien, selon quelle proportion, quel ordre, etc.
- Relationnelle
- Qui, quoi, avec qui, avec quoi, etc.
- Où, dans quelle région, selon quel parcours, quelle étendue, etc.
- Spatiale
- Rossy et al. (2019)

![](figs/slide18_img1.png)
